                ...
                <table class="table table-bordered mb-5 mt-3">
                    ...
                    <c:forEach var="item" items="${listOrderDrinkingCup_Waiting}">
                        <tr>
                            ...
                            <td>
                                <form method="post" action="${pageContext.request.contextPath}/staff/drinkingCups/updateBilldetail/${item[0]}">
                                    <button type="submit"
                                            class="btn btn-sm btn-outline-secondary">Xác nhận đơn hàng
                                    </button>
                                </form>
                            </td>
                        </tr>
