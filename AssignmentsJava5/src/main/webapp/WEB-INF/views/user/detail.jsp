            ...
            <div id="product-carousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner bg-light">
                    <div class="carousel-item active">
                        ...
                        <img class="img-fluid w-100" style="" src="${ pageContext.request.contextPath }/img/${drinkingCups.img}" alt="">
                    </div>
        ...
        <div class="col-lg-7 h-auto mb-30">
            <div class="h-100 bg-light p-30">
                ...
                <p class="mb-4">Volup erat ipsum diam elitr rebum et dolor. Est nonumy elitr erat diam stet sit
                    ...
                    Nonumy</p>
                <div class="d-flex mb-3">
                    <strong class="text-dark mr-3">Sizes: ${drinkingCups.size}</strong>// hai cái này giiongs nhau đc chưa
                </div>
                <div class="d-flex mb-4">
                    <strong class="text-dark mr-3">Colors: ${drinkingCups.color}</strong>

                </div>
                <div class="d-flex align-items-center mb-4 pt-2">

                    <a class="btn btn-outline-dark btn-square" href="${ pageContext.request.contextPath }/user/addToCart/${drinkingCups.id}"><i class="fa fa-shopping-cart"></i></a>
                </div>
