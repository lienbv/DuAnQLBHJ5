...
<script !src="">
	function showMess() {
		var ques = confirm('Do you want to confirm?');
		if (ques == true) {
			window.location.href = '${pageContext.request.contextPath}/staff/drinkingCups/updateBilldetail';
		} else {
	...
	function showCancel() {
		...
		if (ques == true) {
			window.location.href = '${pageContext.request.contextPath}/staff/drinkingCups/cancelBilldetail';
		} else {
